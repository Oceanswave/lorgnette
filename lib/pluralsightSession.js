...
class PluralsightSession {
    ...
    *loginAsync(username, password) {
        ...
        if (aSignInText === "Sign in") {
            ...
            yield this._nightmare.goto("https://app.pluralsight.com/id?");

            yield delay(1000);

            debug("loginAsync() Typing Credentials.");
            yield this._nightmare.type("#Username", username);
            yield this._nightmare.type("#Password", password);

            yield delay(1000);

            debug("loginAsync() Clicking Login.");
            yield this._nightmare.click("#login");
    ...
    *gotoDashboard() {
        ...
        yield this._nightmare.goto("https://app.pluralsight.com/library")
            .wait();
